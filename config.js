var tokens = {
  ...
  MONGO_URI: process.env.MONGO_URI || 'mongodb://localhost:27017/food',
 // MONGO_URI: process.env.MONGO_URI || 'mongodb://sparsh:password@iad1-mongos1.objectrocket.com:16321/food',
